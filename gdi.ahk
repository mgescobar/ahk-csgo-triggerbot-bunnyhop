class GDI
{
	__New(hWnd, CliWidth=0, CliHeight=0,Backgroundcolor=0x000000)
	{
		...
		;this.hMemDC := DllCall("CreateCompatibleDC", "UPtr", this.hDC, "UPtr"), this.hBitmap := DllCall("CreateCompatibleBitmap", "UPtr", this.hDC, "Int", this.CliWidth, "Int", this.CliHeight, "UPtr"), this.hOriginalBitmap := DllCall("SelectObject", "UPtr", this.hMemDC, "UPtr", this.hBitmap)
